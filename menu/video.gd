...
@export var fullsreen_check: CheckBox
...
func _ready() -> void:
	...
	fullsreen_check.toggled.connect(_on_fullscreen_check_toggled)
...
func load_current_settings() -> void:
	...
	fullsreen_check.button_pressed = mode == DisplayServer.WINDOW_MODE_EXCLUSIVE_FULLSCREEN
...
func _on_borderless_check_toggled(enabled: bool) -> void:
